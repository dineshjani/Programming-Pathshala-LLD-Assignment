...
class GetParkingFeesApi:
    ...
    def pay_parking_fees_api(ticket, payment_mode, payment_details: dict):
        ...
        if payment_mode == PaymentMode.CARD:
            payment_processor = PaymentProcessorFactory.get_card_payment_processor(
                payment_details.get("amount"), payment_details.get("card_details")
            )
        elif payment_mode == PaymentMode.CASH:
            payment_processor = PaymentProcessorFactory.get_cash_payment_processor(
